...
class ModelAccountCustomer extends Model {
	...
	public function verifyCustomer($customer_id) {
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET verified=1 WHERE customer_id = '" . (int)$customer_id . "'");
	}
	...
	public function getCustomerByPhone($telephone) {
		$query = $this->db->query("SELECT customer_id, firstname, lastname, email, telephone FROM `" . DB_PREFIX . "customer` WHERE verified=1 AND telephone = '" . $this->db->escape($telephone) . "' LIMIT 1");
	...
	public function getTotalCustomersByTelephone($telephone) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer WHERE verified=1 AND telephone = '" . $this->db->escape($telephone) . "'");
