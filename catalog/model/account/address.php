...
class ModelAccountAddress extends Model {
	...
	public function getAddressesBasic() {
		$query = $this->db->query("SELECT address_id, address_1, address_2, city, postcode FROM " . DB_PREFIX . "address WHERE customer_id = '" . (int)$this->customer->getId() . "'");
		return $query->rows;
	}
