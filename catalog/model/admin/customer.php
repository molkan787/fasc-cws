...
class ModelAdminCustomer extends Model {
	...
	public function patchCustomer($customer_id, $data){
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "' WHERE customer_id = '" . (int)$customer_id . "'");
	}
	...
	public function setCustomerStoreId($customer_id, $store_id){
	...
	public function getCustomers($data = array()) {
		...
		if (isset($data['filter_status']) && $data['filter_status'] !== '') {
			$implode[] = "c.verified = '" . (int)$data['filter_status'] . "'";
		}
		...
		if ($data['store'] !== '') {
			$implode[] = "c.store_id = '" . (int)$data['store'] . "'";
		}
