...
class ControllerAccountAddress extends Controller {
	...
	protected function getForm() {
		...
		$cityNames = $this->model_admin_setting->getStoreCityNames($this->config->get('config_store_id'));
		$lang = $this->config->get('config_language_id');

		if (isset($cityNames[$lang])) {
			$data['city'] = $cityNames[$lang];
		} else {
			$data['city'] = '';
		}
	...
	protected function validateForm() {
		...
		$this->request->post['city'] = "Pipariya";
